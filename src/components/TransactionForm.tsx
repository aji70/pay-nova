...
export default function TransactionForm() {
  ...
  const { generateTransaction } = usePayNovaContract();
    ...
    async (ref: string) => {
      ...
      try {
        const data = (await publicClient.readContract({
          address: '0x8DE814f6b762113413E0304706C92AE5203df41b' as Address,
          abi: PayNovaABI,
          ...
          <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[95vh] overflow-y-auto print:max-w-none print:max-h-none print:overflow-visible print:rounded-none print:shadow-none print:border-0 print:bg-white border border-gray-200">
            <div className="p-8 space-y-6 print:p-12">
              <div className="hidden print:block text-center mb-12 border-b-2 border-gray-900 pb-8">
                ...
                <p className="text-2xl mt-6 text-gray-600">Generated: {new Date(Number(invoice.timestamp) * 1000).toLocaleString()}</p>
              ...
              <div className="flex justify-between items-center print:justify-center">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900">Receipt Generated</h3>
                    <p className="text-gray-600">Ready to pay or share</p>
                  </div>
                </div>
              ...
              {invoice.status === 0 && (
                <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border border-yellow-200 rounded-xl p-4">
                  <div className="flex items-center space-x-2 text-yellow-800">
                    ...
                    <span>Pending – auto-updates when confirmed</span>
                  </div>
                </div>
              )}
                ...
                <dl className="divide-y divide-gray-200 text-sm">
                  ...
                  <div className="px-6 py-4 flex justify-between items-center bg-blue-50">
                    ...
                    <dd className="text-2xl font-bold text-gray-900">
                      {formatAmount(invoice.amount, txnDecimals)} {generatedTokenSymbol}
                    </dd>
                  </div>
                  <div className="px-6 py-4 flex justify-between items-center">
                  ...
                  <div className="px-6 py-4 flex justify-between items-center">
                    ...
                    <dd>
                      <span className={`inline-flex px-3 py-1 rounded-full text-sm font-semibold ${
                        invoice.status === 0 ? 'bg-yellow-100 text-yellow-800' :
                        invoice.status === 1 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                      }`}>
              ...
              <p className="text-xs text-gray-500 text-center print:hidden">
                Track anytime using <code className="bg-gray-100 px-2 py-1 rounded font-mono">getTransaction(ref)</code>
              </p>
            </div>
          </div>
        </div>
