...
export default function TransactionList() {
  ...
  /** NEW – safe formatting using viem's formatUnits */
  const formatAmount = (amt: bigint, dec: number): string => {
    if (amt === 0n) return '0';
    try {
      const formatted = formatUnits(amt, dec);
      // Remove trailing zeros & possible trailing dot
          ...
          <div className="mt-8 bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 p-6 sm:p-8">
            ...
            <dl className="space-y-4 text-sm">
              ...
              <div className="flex justify-between items-center py-3 border-b border-white/10 bg-blue-900/30 rounded-lg px-4">
                ...
                <dd className="text-2xl font-bold text-white flex items-center gap-2">
                  <span>{formatAmount(transaction.amount, decimals)}</span>
                  <span className="text-lg text-purple-200">{tokenSymbol}</span>
                </dd>
              </div>

              <div className="flex justify-between items-center py-3 border-b border-white/10">
                <dt className="text-purple-200 flex items-center">
                  <CurrencyDollarIcon className="w-4 h-4 mr-2" /> Token
                </dt>
              ...
              <div className="flex justify-between items-center py-3 border-b border-white/10">
                <dt className="text-purple-200 flex items-center">
                  <ClockIcon className="w-4 h-4 mr-2" /> Generated
                </dt>
          ...
          <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[95vh] overflow-y-auto print:max-w-none print:max-h-none print:overflow-visible print:rounded-none print:shadow-none print:border-0 print:bg-white border border-gray-200">
            <div className="p-8 space-y-6 print:p-12">
              ...
              <div className="flex justify-between items-center print:justify-center">
                ...
                <button
                  onClick={closeModal}
                  className="text-gray-400 hover:text-gray-600 text-3xl font-bold print:hidden"
                >
                  ×
                </button>
              </div>
                ...
                <dl className="divide-y divide-gray-200 text-sm">
                  ...
                  <div className="px-6 py-4 flex justify-between items-center bg-green-50">
                    ...
                    <dd className="text-2xl font-bold text-gray-900 flex items-center gap-2">
                      <span>{formatAmount(transaction.amount, decimals)}</span>
                      <span className="text-lg text-green-600 font-semibold">{tokenSymbol}</span>
                    </dd>
                  </div>

                  <div className="px-6 py-4 flex justify-between items-center">
                    <dt className="text-gray-700 flex items-center space-x-2">
                      <UserIcon className="w-4 h-4 text-gray-400" /> Paid To
                    </dt>
